...
if __name__ == '__main__':
    ...
    parser.add_argument('--beta_household', type=float, default=0.05,
                        help="Infectivity within a household")
    parser.add_argument('--mob_settings', type=str, default='lib/mobility/San_Francisco_settings_100_type0-1-2-3_20pct_social_graph.pk', 
...
#     testing_params_SD_6['test_smart_num_contacts'] = 5 # this is used only when unlimited_tracing is False
    ...
    for policy in ['basic']:
        ...
        for num_contacts in [2, 5, 10, 15, 20, 25]:
            
            testing_params_SD_6['test_smart_num_contacts'] = num_contacts
            ...
            print(policy, p, num_contacts, ' done.')
