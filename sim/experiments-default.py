...
if __name__ == '__main__':
    ...
    parser.add_argument('--sim_days', type=int, default=10, 
                        help="Integer number of days to run simulation. Default 12 weeks (84 days).")
    parser.add_argument('--outfile', type=str, default='summaries_default', 
    ...
    parser.add_argument('--random_repeats',type=int, default=6, 
    ...
    parser.add_argument('--mob_settings', type=str, default='lib/mobility/San_Francisco_settings_200.pk', 
...
#     beta = 1.1383
    ...
    save_summary(res, f'{args.outfile}.pk')
