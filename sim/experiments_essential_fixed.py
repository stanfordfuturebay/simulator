...
#     beta = 1.1383
    ...
    summaries_SD_6 = {'random':[], 'essential':[]}
    ...
    for policy in ['advanced']:
        ...
        for p in p_compliance:
            ...
            # compliant individuals randomly chosen
            ...
            summaries_SD_6['random'].append(res)
            print('ComplianceForAllMeasure', p, ' done.')
            ...
            res = run(testing_params_SD_6, m, max_time_future, present_seeds)
            summaries_SD_6['essential'].append(res)
