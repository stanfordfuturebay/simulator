...
class MobilitySimulator:
    ...
    def __init__(self, delta, home_loc=None, people_age=None, site_loc=None, site_type=None,
        ...
        if synthetic:
            ...
            self.essential_workers = np.array([False for i in range(self.num_people)]) if essential_workers is None else np.array(essential_workers)
            self.essential_mob_rate_per_type = self.mob_rate_per_age_per_type if essential_mob_rate_per_type is None else np.array(essential_mob_rate_per_type)
