...
#         sequential
    ...
    def compare_total_infections(self, sims, titles, figtitle='Title',
        ...
        subplot_adjust=None, start_date='2020-03-01', first_one_dashed=False):
        ...
        if show_legend:
            # legend
            if legend_is_left:
                leg = ax.legend(loc='upper left', borderaxespad=0.5,prop={'size': 8})
            else:
                leg = ax.legend(loc='upper right', borderaxespad=0.5, prop={'size': 8})
    ...
    def plot_positives_vs_target(self, sim, targets, title='Example',
        filename='inference_0', figsize=(6, 5), errorevery=1, acc=17, ymax=None,downsample=None,
        start_date='2020-03-08', lockdown_label='Lockdown', lockdown_at=None,
        ...
        ax.plot(xx, posi_mu*downsample, c='k', linestyle='-',
                label='COVID-19 simulated case data')
        ax.fill_between(xx, (posi_mu - posi_sig)*downsample, (posi_mu + posi_sig)*downsample,
