...
class CovidDistributions(object):
    ...
    def __init__(self, country):
        ...
        elif country == 'US':   # TODO: Laura- accept area+country
            self.fatality_rates_by_age = np.array([0.0, 0.0, 0.0021, 0.0021, 0.0021, 0.0032, 0.0365, 0.2077])
            self.p_hospital_by_age = np.array([0.051, 0.020, 0.069, 0.069, 0.091, 0.233, 0.538, 0.810]) # SF data
        else:
