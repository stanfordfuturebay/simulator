...
def generate_population(bbox, population_per_age_group, density_files=None, tile_level=16, seed=None, density_site_loc=None,
                        essential_prop_per_age_group=None,essential_prop=None): # emma
...
#                 if (np.random.rand()<essential_prop):
                a = np.random.rand()
                if new_people_ages[i] == 0:                        
                    b = (a<essential_prop_per_age_group[0])
                    essential_workers += [b]
                elif new_people_ages[i] == 1:
                    b = (a<(essential_prop_per_age_group[1]))
                    essential_workers += [b]
                elif new_people_ages[i] == 2:
                    b = (a<(essential_prop_per_age_group[2]))
                    essential_workers += [b]
                elif new_people_ages[i] == 3:
                    b = (a<essential_prop_per_age_group[3])
                    essential_workers += [b]
                elif new_people_ages[i] == 4:
                    b = (a<(essential_prop_per_age_group[4]))
                    essential_workers += [b]
                elif new_people_ages[i] == 5:
                    b = (a<essential_prop_per_age_group[5])
                    essential_workers += [b]
