...
class MobilitySimulator:
    ...
    def __init__(self, delta, home_loc=None, people_age=None, site_loc=None, site_type=None,
                ...
                dur_mean=None, num_age_groups=None, seed=None, verbose=False, essential_workers=None, essential_mob_rate_per_type=None, essential_dur_mean_per_type=None, essential_work_site = None, essential_type = None):
        """
        delta : float
        ...
        synthetic = (num_people is not None and num_sites is not None and mob_rate_per_type is not None and
                    dur_mean is not None and num_age_groups is not None and essential_workers is not None and essential_mob_rate_per_type is not None and essential_dur_mean_per_type is not None and essential_work_site is not None and essential_type is not None)

        real = (home_loc is not None and people_age is not None and site_loc is not None and site_type is not None and site_dict is not None and num_people_unscaled is not None and region_population is not None and downsample is not None and mob_rate_per_age_per_type is not None and dur_mean_per_type is not None and variety_per_type is not None and daily_tests_unscaled is not None and delta is not None and home_tile is not None and tile_site_dist is not None and people_household is not None and essential_workers is not None and essential_mob_rate_per_type is not None and essential_dur_mean_per_type is not None and essential_work_site is not None and essential_type is not None)
