...
#                print(pops_in_tile['lat'])
                tiles = tiles.append(pd.DataFrame(data={'lat': [lat], 'lon': [lon], 'pop': [sum(pops_in_tile['Baseline: People'])]}))
    ...
    return home_loc, people_age, home_tile, tile_loc, people_household, essential_workers, num_essential_workers, essential_work_site
