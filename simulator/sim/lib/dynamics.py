...
class DiseaseModel(object):
    ...
    def launch_epidemic(self, params, initial_counts, testing_params, measure_list, verbose=True):
        ...
        while self.queue:
            ...
            if event == 'expo':
                ...
                self.__process_testing_event(t, i, num_not_compliant) # emma                
    ...
    def is_person_home_from_visit_due_to_measure(self, t, i, visit_id):
        ...
        is_home = (
            ...
            self.measure_list.is_contained(
                ...
                j=i, j_visit_id=visit_id,essential=self.mob.essential_workers[i]) or
            self.measure_list.is_contained(
    ...
    def __process_testing_event(self, t, i, num_not_compliant):
        """
        ...
        if self.state['posi'][i] and (self.smart_tracing != None):
            if (self.mob.essential_workers is None) or (self.mob.essential_workers[i] is True):   #Laura
            ...
            for k in range(self.n_sites):
                ...
                while next_contact_obj is not None:
                    ...
                    is_i_contained = (
                        ...
                        self.measure_list.is_contained(
                            SocialDistancingForNonEssential, t=next_contact,
                            j=i, j_visit_id=j_visit_id, essential=self.mob.essential_workers[i])
                    )
                    
                    # 3) check whether susceptible stayed at home due to measures
                    i_contained = self.is_person_home_from_visit_due_to_measure(
                        t=t, i=i, visit_id=i_visit_id)   # emma
