...
def generate_population(bbox, population_per_age_group, density_file=None, tile_level=16, seed=None,
                        ...
                        essential_prop_per_age_group=None): #Laura Change
    
#     if essential_prop_per_age_group is None:
#         essential_prop_per_age_group = [0 for i in range(len(population_per_age_group))]
    ...
    return home_loc, people_age, home_tile, tile_loc, people_household, essential_workers, num_essential_workers
